(function () {
    ...
    function y(e, a) {
        var r, d = {};
        for (r in a = a || {},
            e = e || {}) e.hasOwnProperty(r) && (d[r] = e[r]);
    ...
    function d(d, g) {
        var C = ""; !
            function (e, a) {
                for (var r = 0,
                    d = $.length; r < d; r++) for (var g = $[r], C = g.patterns, n = 0, p = C.length; n < p; n++) {
                        var c = C[n];
                        if (new RegExp(c.reg).test(e)) {
                            var t = y(g, c);
                            return delete t.patterns,
                                delete t.reg,
                                t.cardTypeName = T(t.cardType),
                                a(null, t)
                        }
                    }
                a(null)
                ...
                function (e, a) {
                    ...
                    "undefined" != typeof module && module.exports ?
                        // require("https").get("https://ccdcapi.alipay.com/validateAndCacheCardInfo.json?_input_charset=utf-8&cardNo=" + d + "&cardBinCheck=true",
                        //     function (e) {
                        //         console.info("------e.statusCode----", e.statusCode)
                        //         if (200 == e.statusCode) {
                        //             var r = "";
                        //             e.on("data",
                        //                 function (e) {
                        ...
                        //                         try {
                        //                             var e = JSON.parse(r);
                        //                             console.info("------JSON.parse(r)----", r)
                        //                             if (e.validated) {
                        //                                 var a = {};
                        //                                 a.bankName = function (e) {
                        //                                     for (var a = 0, r = $.length; a < r; a++) {
                        //                                         var d = $[a];
                        //                                         if (e == d.bankCode) return d.bankName
                        //                                     }
                        //                                     return ""
                        //                                 }(e.bank),
                        //                                     a.cardType = e.cardType,
                        //                                     a.bankCode = e.bank,
                        //                                     a.cardTypeName = T(e.cardType),
                        //                                     a.backName = a.bankName,
                        //                                     g(null, a)
                        //                             } else g(C = d + ":该银行卡不存在," + r)
                        //                         } catch (e) {
                        //                             console.info("------catch (e)----", e)
                        //                             g(C = d + ":获取alipay接口信息出错了,返回json格式不正确")
                        //                         }
                        //                     })
                        //         } else C = d + ":获取alipay接口信息出错了,statusCode," + e.statusCode,
                        //             g(C)
                        //     }).on("error",
                        //         function (e) {
                        //             g(C = d + ":获取alipay接口信息出错了")
                        //         })
                        g("err0")
                        : g(d + ":该银行卡不存在")
                })
    ...
    function r(e, r) {
        var a;
        return a = r,
            "[object Function]" !== Object.prototype.toString.call(a) && (r = function () { }),
            isNaN(e) && (e = parseInt(e), isNaN(e)) ? r(e + ":银行卡号必须是数字") : e.toString().length < 15 || 19 < e.toString().length ? r(e + ":银行卡位数必须是15到19位") : void d(e,
                function (e, a) {
                    r(e, a)
                })
    }
    ...
    "undefined" != typeof exports ? ("undefined" != typeof module && module.exports && (exports = module.exports = {
        getBankBin: e
    }), exports.getBankBin = e) : "function" == typeof define && define.amd ? define("bankInfo", [],
        function () {
            return {
                getBankBin: r
            }
