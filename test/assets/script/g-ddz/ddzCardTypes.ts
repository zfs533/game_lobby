    ...
    protected start() {
        ...
        this.openAnim(() => {
            ...
            let allInfoArr: Array<{ desc: string, paiData: Array<number> }> = [
                { desc: "火箭", paiData: [CARD_SHAPE.BLACK_JOKER, CARD_SHAPE.RED_JOKER] },
                ...
                { desc: "顺子", paiData: [CARD_SHAPE.SPADES_3, CARD_SHAPE.SPADES_4, CARD_SHAPE.SPADES_5, CARD_SHAPE.SPADES_6, CARD_SHAPE.SPADES_7] },
                {
                    ...
                    CARD_SHAPE.HEART_7, CARD_SHAPE.DIAMOND_7]
                },
                {
                ...
                {
                    desc: "三连带对", paiData: [CARD_SHAPE.HEART_3, CARD_SHAPE.DIAMOND_3, CARD_SHAPE.PLUM_3,
                    CARD_SHAPE.HEART_4, CARD_SHAPE.DIAMOND_4, CARD_SHAPE.PLUM_4,
                    CARD_SHAPE.HEART_5, CARD_SHAPE.DIAMOND_5, CARD_SHAPE.HEART_6, CARD_SHAPE.DIAMOND_6]
                },
                {
                ...
                {
                    desc: "四带两对", paiData: [CARD_SHAPE.HEART_K, CARD_SHAPE.DIAMOND_K, CARD_SHAPE.SPADES_K, CARD_SHAPE.PLUM_K,
                    CARD_SHAPE.SPADES_3, CARD_SHAPE.PLUM_3, CARD_SHAPE.SPADES_4, CARD_SHAPE.PLUM_4]
                },
            ];
            ...
            for (let idx = 0; idx < allInfoArr.length; idx++) {
                ...
                for (let paiIdx = 0; paiIdx < allInfo.paiData.length; paiIdx++) {
                    ...
                    let model = this.pokerRes.getDdzCard(pai);
                    model.y = 0;
