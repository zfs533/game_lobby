...
@ccclass
export default class HHPlayerMgr extends PlyMgr<HHPlayer, HHGame> {
    ...
    updatePly(p: HHPlayer, data: ps.User) {
     ...
     * @param player 富豪或赌神
     */
    private chgBigRegalGambleGod(newPos: number, player: HHPlayer) {
        // 填补新富豪
