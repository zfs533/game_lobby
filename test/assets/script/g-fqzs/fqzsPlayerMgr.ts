...
@ccclass
export default class FQZSPlayerMgr extends PlyMgr<FQZSPlayer, FQZSGame> {
    ...
    updatePly(p: FQZSPlayer, data: ps.User) {
     ...
     * @param player 富豪或赌神
     */
    private chgBigRegalGambleGod(newPos: number, player: FQZSPlayer) {
        // 填补新富豪
