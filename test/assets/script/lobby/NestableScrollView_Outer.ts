...
@ccclass
export default class NestableScrollView_Outer extends cc.ScrollView {
    @property([NestableScrollView_Inner])
    public m_InnerScrollViews: NestableScrollView_Inner[] = [];        // 挂内嵌的ScrollView

    private m_PlanDir;      // 计划方向, 本次滑动的目的方向。根据刚开始滑动的方向决定 0为不限制方向, 1为横, -1为纵

    private m_ScrollingInnerSv;
    onLoad() {
